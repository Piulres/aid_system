{
	...
	class Panel {
		constructor(el) {
			...
			this.DOM.enter1 = DOM.intro.querySelector('.enter1');
			this.DOM.enter2 = DOM.intro.querySelector('.enter2');
			this.DOM.enter3 = DOM.intro.querySelector('.enter3');
		...
		initEvents() {
			this.DOM.enter1.addEventListener('click', (ev) => {
				ev.preventDefault();
				this.close();
			});

			this.DOM.enter2.addEventListener('click', (ev) => {
				ev.preventDefault();
				this.close();
			});

			this.DOM.enter3.addEventListener('click', (ev) => {
				ev.preventDefault();
				this.close();
			});
