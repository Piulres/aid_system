...
class ClientStatusController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = ClientStatus::with(['team'])->select(sprintf('%s.*', (new ClientStatus)->table));
        ...
        return view('admin.clientStatuses.index', compact('teams'));
    }
    ...
    public function show(ClientStatus $clientStatus)
    {
        ...
        $clientStatus->load('team', 'statusClients');
