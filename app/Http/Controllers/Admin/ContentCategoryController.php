...
class ContentCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = ContentCategory::with(['team'])->select(sprintf('%s.*', (new ContentCategory)->table));
        ...
        return view('admin.contentCategories.index', compact('teams'));
    }
    ...
    public function show(ContentCategory $contentCategory)
    {
        ...
        $contentCategory->load('team', 'categoryContentPages');
