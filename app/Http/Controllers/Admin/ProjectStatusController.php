...
class ProjectStatusController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = ProjectStatus::with(['team'])->select(sprintf('%s.*', (new ProjectStatus)->table));
        ...
        return view('admin.projectStatuses.index', compact('teams'));
    }
    ...
    public function show(ProjectStatus $projectStatus)
    {
        ...
        $projectStatus->load('team', 'statusProjects');
