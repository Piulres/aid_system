...
class ContentPageController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = ContentPage::with(['categories', 'tags', 'team'])->select(sprintf('%s.*', (new ContentPage)->table));
        ...
        return view('admin.contentPages.index', compact('content_categories', 'content_tags', 'teams'));
    }
