...
class TransactionTypeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = TransactionType::with(['team'])->select(sprintf('%s.*', (new TransactionType)->table));
        ...
        return view('admin.transactionTypes.index', compact('teams'));
    }
    ...
    public function show(TransactionType $transactionType)
    {
        ...
        $transactionType->load('team', 'transactionTypeTransactions');
