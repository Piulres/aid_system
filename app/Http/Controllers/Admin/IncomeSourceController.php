...
class IncomeSourceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = IncomeSource::with(['team'])->select(sprintf('%s.*', (new IncomeSource)->table));
        ...
        return view('admin.incomeSources.index', compact('teams'));
    }
    ...
    public function show(IncomeSource $incomeSource)
    {
        ...
        $incomeSource->load('team', 'incomeSourceTransactions');
