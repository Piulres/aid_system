...
class ClientController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Client::with(['status', 'team'])->select(sprintf('%s.*', (new Client)->table));
        ...
        return view('admin.clients.index', compact('client_statuses', 'teams'));
    }
    ...
    public function show(Client $client)
    {
        ...
        $client->load('status', 'team', 'clientProjects');
